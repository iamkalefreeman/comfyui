...
const workflow: Workflow = {
  RequestSchema,
  generateWorkflow,
  summary: "Qwen Text-Guided Image Editing",
  description: "Edits an input image based on a text prompt using the Qwen-Image model. This workflow generates 3 variations.",
};
